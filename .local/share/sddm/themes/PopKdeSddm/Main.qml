...
PlasmaCore.ColorScope {
    ...
    StackView {
        ...
        initialItem: Login {
            ...
            actionItems: [
                ActionButton {
                    iconSource: Qt.resolvedUrl("images/suspend.svg")// "system-suspend"
                ...
                ActionButton {
                    iconSource: Qt.resolvedUrl("images/restart.svg")//"system-reboot"
                ...
                ActionButton {
                    iconSource: Qt.resolvedUrl("images/shutdown.svg")//"system-shutdown"
                ...
                ActionButton {
                    iconSource: Qt.resolvedUrl("images/other.svg")//"system-search"
